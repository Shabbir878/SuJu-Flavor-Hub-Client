...
// //               <div
// //                 key={comment._id}
// //                 className="border border-gray-700 rounded-xl p-2 shadow-lg bg-gray-800 bg-opacity-60 flex items-center gap-4 hover:bg-gray-700 transition-all duration-300 transform hover:scale-105"
// //               >
// //                 <Link href={`/profile/${comment?.commentUserId}`}>
// //                   <Avatar
// //                     className="w-12 h-12 rounded-full border-2 border-teal-400 shadow-lg"
